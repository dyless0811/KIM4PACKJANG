...
<body onload="calculate();">
	...
	<div class="float-container list-card">
		...
		<div class="float-item-left list-card-content">
			<h2>
				상품명:<%=productDto.getName()%></h2>
			<h5>
				조회수:<%=productDto.getViews()%></h5>
			<h4>
				소분류번호:<%=productDto.getSmallTypeNo()%>
		...
		<h4>
			가격:<%=productDto.getPrice()%>원
		</h4>
		<div>
			구매수량 <input type="number" value="1" id="count" oninput="calculate();"
				min="1">개
		</div>
		<div class="row">
			결제금액 <input type="number" placeholder=0 id="result">원
			<div>
				<div class="row">
